...
> Design notes for **cli-login-sms-codes** — a runnable go example that Single-binary Go daemon behind a CLI phone-code login: issue a code, classify the answer, report delivery.
